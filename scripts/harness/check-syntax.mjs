...
export const SYNTAX_CHECK_FILES = Object.freeze([
  ...
  "src/server/metadataDb.js",
  "src/server/objectDbStorage.js",
  "src/server/objectStorage.js",
  ...
  "scripts/harness/db-migrate.mjs",
  "scripts/harness/migrate-file-storage-to-object-db.mjs",
  "scripts/harness/object-db-verify.mjs",
  ...
  "scripts/harness/source-revision.mjs",
