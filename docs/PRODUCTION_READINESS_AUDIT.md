...
The latest full test run passed 303 Node tests, and the baseline browser E2E
...
- audit retention; design exists in
  ...
  exists through `scripts/harness/audit-verify.sh`, but retention pruning is
  still pending
